...
scaler_file = "src/Train-Models/scaler_spread.pkl"
...
for x in tqdm(range(100)):
    x_train, x_test, y_train, y_test = train_test_split(data_scaled, spread, test_size=.1)
    ...
    if acc == max(acc_results):
        model.save_model('Models/XGBoost_{}%_Spread-scaled.json'.format(acc))
